...
<https://github.com/ataciuk/DSCI_521_lab4_ataciuk.git>
...
https://ataciuk.github.io/DSCI_521_lab4_ataciuk/
...
```{r Answer to Question 4, include=TRUE}

print("This is question 4")
```

The above code chunk option will include code and results in the finished file.
...
```{r Answer to question 5, echo=TRUE, message=TRUE}

# message=TRUE will maintain messages produced by the code in the file
# echo=FALSE would hide the code from the finished file, but keep the results in the knitted file 
...
<https://github.com/ataciuk/DSCI_521_lab4_ataciuk/blob/master/question-7-lab-4.html>

<https://github.com/ataciuk/DSCI_521_lab4_ataciuk/blob/master/question-7-lab-4.pdf>
...
<https://github.com/ataciuk/DSCI_521_lab4_ataciuk/blob/master/question-8-lab-4.Rmd>

<https://github.com/ataciuk/DSCI_521_lab4_ataciuk/blob/master/question-8-lab-4.html>
...
https://github.com/ataciuk/DSCI_521_lab4_ataciuk/blob/master/question-9-lab-4.md

It is rendered like a jupyter markdown file!
...
https://ataciuk.github.io/DSCI_521_lab4_ataciuk/question-10-lab-4-2.html#1
